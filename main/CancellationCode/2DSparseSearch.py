...
if __name__ == "__main__":
	...
	plt.scatter(phaselist, voltlist)

	plt.show()

	plt.scatter(gainlist, voltlist)
	...
	ax.scatter(phaselist, gainlist, voltlist)

	plt.show()

	dac1.updateVal(holder[0])
	dac2.updateVal(holder[1])
